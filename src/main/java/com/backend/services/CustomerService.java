...
public class CustomerService {
    ...
    public Customer updateCustomerById(Long id, RequestUpdateCustomer request, HttpServletResponse response) {
        ...
        processMailIfUpdated(request, response, customer, oldEmail);
    ...
    private void processMailIfUpdated(RequestUpdateCustomer request, HttpServletResponse response, Customer customer, String oldEmail) {
    ...
    public Customer updateCustomer(RequestUpdateCustomer request, HttpServletResponse response) {
        ...
        /*          Customer        */
        s(request, response, customer, oldEmail);
